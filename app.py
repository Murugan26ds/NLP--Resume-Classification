...
import nltk
nltk.data.path.append("C:\\Users\\MURUGAN\\nltk_data")
nltk.download("punkt", download_dir="C:\\Users\\MURUGAN\\nltk_data")
nltk.data.path.append("C:\\Users\\MURUGAN\\nltk_data")
nltk.download("wordnet", download_dir="C:\\Users\\MURUGAN\\nltk_data")
...
def preprocess(sentence):
    ...
    filtered_words = [w for w in tokens if len(w) > 2 if not nlp.vocab[w].is_stop]
